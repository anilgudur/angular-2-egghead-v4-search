...
export class WikipediaComponent {
    ...
    ngOnInit(): void {
        this.term$
            ...
            .flatMap(term => this.wikipediaSearchService.search(term)) // when a map has a observable into a observable of observable then flatMap automatically subscribe to this inner observable and flattens them into just a one observable of same type
